        ...
        <article className="space-y-6">
          ...
          {resource.content && (
            <div className="bg-surface border border-border-subtle rounded-xl p-6">
              <div className="prose prose-sm prose-invert max-w-none text-ink-muted">
                <pre className="whitespace-pre-wrap font-sans text-sm leading-relaxed">{resource.content}</pre>
              </div>
            </div>
          )}
