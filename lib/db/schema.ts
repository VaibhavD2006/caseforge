...
export const interviewSessions = pgTable('interview_sessions', {
  ...
  aiCostEstimateCents: decimal('ai_cost_estimate_cents', {
    precision: 10,
    scale: 4,
  })
    .notNull()
...
export const goals = pgTable('goals', {
  ...
  currentValue: decimal('current_value', { precision: 5, scale: 2 }).default(
    '0'
  ),
...
export const leaderboardScoreCache = pgTable('leaderboard_score_cache', {
  ...
  leaderboardScore: decimal('leaderboard_score', {
    precision: 6,
    scale: 3,
  }).notNull(),
